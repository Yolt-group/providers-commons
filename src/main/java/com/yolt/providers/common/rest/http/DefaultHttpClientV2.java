...
/**
 * @deprecated use DefaultHttpClientV3, remove in C4PO-7297
 */
@Deprecated
@Slf4j
@RequiredArgsConstructor
public class DefaultHttpClientV2 implements HttpClient {
    ...
    private final HttpErrorHandlerV2 defaultHttpErrorHandler = new TooManyRequestsErrorHandler();
    ...
    public <T> ResponseEntity<T> exchange(final String endpoint,
        ...
        try {
            ...
            defaultHttpErrorHandler.handle(e, errorHandlerParameters);
