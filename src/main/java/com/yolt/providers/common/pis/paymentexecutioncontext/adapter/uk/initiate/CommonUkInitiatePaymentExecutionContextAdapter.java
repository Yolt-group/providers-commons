...
public class CommonUkInitiatePaymentExecutionContextAdapter<PaymentRequest, HttpRequestBody, HttpResponseBody, PreExecutionResult> {
    ...
    public InitiateUkDomesticPaymentResponseDTO initiatePayment(final PaymentRequest paymentRequest) {
